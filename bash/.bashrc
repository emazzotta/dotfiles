...
export PATH="${CUSTOM_BIN_DIR}:/usr/local/bin:/usr/local/Cellar:${PATH}"
...
export DOTFILESCOMMITMSG="Update Dotfiles"
...
export INFRASTRUCTURECOMMITMSG="Update Infrastructure"
...
alias ad='cd ${WDIR}/adcubum;l'
alias ap='cd ${WDIR}/3ap;l'
alias apps='cd ${APPDIR};l'
...
alias bb='cd ${WDIR}/baubox/;l'
alias bbw='cd ${WDIR}/baubox/baubox-webapp;l'
alias bf='vi ${DOTFILESPATH}/Brewfile'
alias boi='cd ${BOILERPLATE_PATH};l'
alias boz='cd ${WDIR}/private/bozzilli;av;l'
alias brci='brew cask install'
alias bri='brew install'
alias bup='echo "Updating Brew";git -C "$(brew --repo)" fetch --tags;brew update;brew upgrade;brew prune;brew cu -afy --cleanup;brew cleanup'
alias c='cash'
...
alias dgc='docker run --rm -v /var/run/docker.sock:/var/run/docker.sock spotify/docker-gc;docker run --rm -v /var/run/docker.sock:/var/run/docker.sock:ro -v /var/lib/docker:/var/lib/docker martin/docker-cleanup-volumes'
alias dgcc='docker system prune'
...
alias em='emacs'
alias ema='cd ${WDIR}/private/emanuele-page;av;l'
alias emptytrash='sudo rm -rfv /Volumes/*/.Trashes; sudo rm -rfv ~/.Trash; sudo rm -rfv /private/var/log/asl/*.asl; sqlite3 ~/Library/Preferences/com.apple.LaunchServices.QuarantineEventsV* "delete from LSQuarantineEvent"'
alias ep='vi ${DOTFILESPATH}/bash/.bashrc;rp'
...
alias hp='cd ${WDIR}/private/homepage;av;l'
alias hrp='cd ${WDIR}/hackathons;l'
alias hz='cd ${WDIR}/hackathons/sustineri;l'
alias inf='cd ${WDIR}/private/infrastructure;l'
alias infu='inf && ./update && ./cloudflare.py && gacp ${INFRASTRUCTURECOMMITMSG}'
...
alias k='kubectl'
alias ke='vi ${DOTFILESPATH}/karabiner/.config/karabiner/karabiner.json'
alias killgpg='killall ssh-agent gpg-agent;gpgconf --kill all'
alias ks='killall ssh'
alias kt='cd ${KATADIR};l'
alias l='clear'
alias lb='cd ${WDIR}/private/lighthouse-badges;l'
alias ll='ls -ltra'
...
alias ocd='spsh && pscribe'
alias path='echo -e ${PATH//:/\\n}'
alias ph='cd ${WDIR}/private/plexius-homepage;l'
...
alias prp='cd ${WDIR}/private;l'
alias trp='cd ${WDIR}/tools;l'
alias st='vi ${DOTFILESPATH}/setup'
alias pspp='cd ${WDIR}/zhaw/pspp'
...
alias spsh='(cd ${DOTFILESPATH};./update;gacp ${DOTFILESCOMMITMSG})'
alias spub='print_and_copy "$(cat ${HOME}/.ssh/id_*.pub)"'
alias sq='cd ${WDIR}/squido/squidoapi;l'
alias sqa='cd ${WDIR}/squido/squidoandroid;l'
alias sqi='cd ${WDIR}/squido/squidoios;l'
alias sqr='cd ${WDIR}/squido/squidoreact;l'
alias sqref='print_and_copy "${SWISSQUOTE_REFERRAL}"'
alias sqw='cd ${WDIR}/squido/squidoweb;l'
alias sref='print_and_copy "${SELMA_REFERRAL}"'
alias ss='sshrc'
alias superocd='(infu) && ocd && update && gupallin "${WDIR}" && gck'
alias t='tig'
...
alias vd='cd ${HOME}/.vim_runtime;l'
...
alias vmup='VBoxManage startvm "UbuntuSecLab" --type headless'
alias w='cd ${WDIR};l'
alias webgoat='docker run -p 8080:8080 -t webgoat/webgoat-7.1'
alias wrk='cd ${WORKDIR};l'
alias y='yarn'
alias ya='yarn add'
