...
alias ba='cd ${WDIR}/zhaw/Bachelorthesis/atc-voice-recognition'
...
alias sig='cd ${HOME}/Library/Mail/V7/MailData/Signatures' # 'cd "${HOME}/Library/Mobile Documents/com~apple~mail/Data/V4/Signatures"'
...
alias update='softwareupdate -i -a; bup;curl --compressed -o- -L https://yarnpkg.com/install.sh | bash;yes | sdk update;yes | sdk upgrade; sudo gem update --system; sudo gem update; sudo gem cleanup'
