...
alias ado='cd ${WDIR}/adcubum/gesus-offer;l;j10'
...
alias h='cd ${HOME}'
alias harvest='(cd ${WDIR}/private/timetracker && dc run timetracker)'
...
alias superocd='(infu) && ocd && update && gupallin "${WDIR}" && zgen update <<< "n" &> /dev/null && gck'
alias t='tig'
