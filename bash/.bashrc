...
alias recreate_py='rm -rf "$VENV_PYTHON_3";pip install virtualenv && genvenv3 "$VENV_PYTHON_3" && reinstall_py'
alias reinstall_py='av && pip install --upgrade pip && pip install -r $DOTFILESPATH/python/requirements.txt'
