...
alias aip='cd $PRIVATE_PROJECTS/katas/opencode/data/opencode/workspace'
alias as='audiospec'
...
alias cl='$PRIVATE_PROJECTS/katas/opencode && make claude'
alias clr='$PRIVATE_PROJECTS/katas/opencode && make claude-resume'
alias cm='matrix'
alias create_backups='envify && tmbackup'
...
alias leoftp='envify && lftp -e "open ftp://${LEO_FTP_USER}:${LEO_FTP_PASS}@${LEO_FTP_URL}"'
alias leoftp_mount='envify && open ftp://${LEO_FTP_USER}:${LEO_FTP_PASS}@${LEO_FTP_URL}'
...
alias oc='$PRIVATE_PROJECTS/katas/opencode && make opencode'
