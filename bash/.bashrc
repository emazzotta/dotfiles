...
alias gesus-ftp='lftp sftp://SVC_ADC-SFTP@internal.loc:$(security find-internet-password -wj swica)@transfer.swica.ch  -e "cd /Applications/GESUS/PROD/DWH_DATA; ls"'
