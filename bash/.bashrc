...
alias reinstall_py='av && pip install ptpython && pip install boto3'
...
alias superocd='ocd && update && rmraycastclipboard && gupallin "$HOME" && zgen update <<< "n" &> /dev/null && gck "$HOME"'
alias t='tig'
