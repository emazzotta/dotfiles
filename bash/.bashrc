...
alias superocd='sshkeyadd && ocd && update && rmraycastclipboard && kill_adobe_processes && rm_launch_items && rmmac && upallin "$HOME" && zgen update <<< "n" &> /dev/null && ck "$HOME" && create_backups'
alias t='lazygit'
