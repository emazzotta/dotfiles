...
alias ycminstall='(cd "${VIM_RUNTIME_DIR}/my_plugins/YouCompleteMe" && git submodule update --init --recursive && ./install.py --clang-completer --gocode-completer --tern-completer --omnisharp-completer)'
