...
export PATH="${CUSTOM_BIN_DIR}:${HOME}/.yarn/bin:${HOME}/.config/yarn/global/node_modules/.bin:/opt/homebrew/bin:${HOME}/.gem/ruby/2.6.0/bin:/usr/local/opt/openssl/bin:/usr/local/opt/curl/bin:/usr/local/bin:/usr/local/Cellar:${PATH}"
