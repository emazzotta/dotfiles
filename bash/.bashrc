...
alias bup='echo "Updating Brew";git -C "$(brew --repo)" fetch --tags;brew update;brew upgrade;brew cleanup;brew cu -afy --cleanup;brew cleanup;yes | sdk update;yes | sdk upgrade'
