...
alias update='softwareupdate -i -a; bup;yes | sdk update;yes | sdk upgrade; npm install npm -g; npm update -g; sudo gem update --system; sudo gem update; sudo gem cleanup'
