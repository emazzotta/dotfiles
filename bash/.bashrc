...
alias gdc='dc -f ${WDIR}/adcubum/gesus-docker-composition/docker-compose.yml'
alias gdl='./gradlew'
...
alias jc='find . -name "build" -or -name "out" | xargs -I {} rm -rf {}'
...
alias update='softwareupdate -i -a; bup;yes | sdk update;yes | sdk upgrade; npm install npm -g; npm update -g; gem update --system; gem update; gem cleanup'
